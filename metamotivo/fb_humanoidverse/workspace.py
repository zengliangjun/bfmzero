...
from metamotivo.fb_humanoidverse.buffers import motion_buffer, replay_buffer as replay
...
class Workspace:
    ...
    def train_online(self, env) -> None:
        ...
        for step in range(1, self.cfg.max_steps + 1):
            ...
            if step % (self.cfg.checkpoint_every_steps * 100) == 0:
                replay_buffer["expert_slicer"].reload_buffer()
