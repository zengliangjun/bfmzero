...
urdf_root = osp.join(root, "humanoidverse_env/data/robots/metamotivo_hum/")
...
for option in asset_config_options:
    option_value = set_value_if_not_none(
        getattr(asset_options, option), asset_config_options[option]
    )
